...
public class ProductController {
	...
	public ResponseEntity<Product> updateProduct(@PathVariable(value = "id") String id, @RequestBody Product newProduct) {
		...
		Optional<Product> thisProduct = productManager.getProduct(id);
		
		if (thisProduct.isPresent()) {
			Optional<Product> updatedProduct = productManager.updateProduct(thisProduct.get(), newProduct);
	...
	public ResponseEntity<Product> deleteProduct(@PathVariable(value = "id") String id) {
		...
		if (thisProduct.isPresent()) {
			productManager.deleteProduct(thisProduct.get());
